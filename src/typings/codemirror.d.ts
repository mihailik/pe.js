...
declare module CodeMirror {
    ...
    function on(doc: Doc, eventName: 'beforeSelectionChange', handler: (instance: CodeMirror.Editor, selection: { head: Pos; anchor: Pos; }) => void );
    function off(doc: Doc, eventName: 'beforeSelectionChange', handler: (instance: CodeMirror.Editor, selection: { head: Pos; anchor: Pos; }) => void );
    ...
    interface Editor {
        ...
        on(eventName: 'beforeSelectionChange', handler: (instance: CodeMirror.Editor, selection: { head: CodeMirror.Pos; anchor: CodeMirror.Pos; }) => void );
        off(eventName: 'beforeSelectionChange', handler: (instance: CodeMirror.Editor, selection: { head: CodeMirror.Pos; anchor: CodeMirror.Pos; }) => void );
    ...
    interface EditorChange {
        /** Pos (in the pre-change coordinate system) where the change started. */
        from: CodeMirror.Pos;
        /** Pos (in the pre-change coordinate system) where the change ended. */
        to: CodeMirror.Pos;
